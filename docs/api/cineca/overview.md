...
| ----------------------------------------------------------------------------- | ------------- | ---------- | ---------------------------------------------------------------------- | ---------------------------------------------------- |
| Centro Alti Studi per la Difesa (CASD) di Roma                                | CASD          | Hosting    | [casd.esse3.cineca.it](https://casd.esse3.cineca.it)                   | `https://casd.esse3.cineca.it/e3rest/docs`           |
| Gran Sasso Science Institute - Scuola di dottorato internazionale dell'Aquila | GSSI          | Hosting    | [gssi.esse3.cineca.it](https://gssi.esse3.cineca.it)                   | `https://gssi.esse3.cineca.it/e3rest/docs`           |
...
| Scuola internazionale superiore di studi avanzati di Trieste                  | SISSA         | Hosting    | [sissa.esse3.cineca.it](https://sissa.esse3.cineca.it)                 | `https://sissa.esse3.cineca.it/e3rest/docs/`         |
| Scuola normale superiore di Pisa                                              | SNS           | Hosting    | [sns.esse3.cineca.it](https://sns.esse3.cineca.it)                     | `https://sissa.esse3.cineca.it/e3rest/docs/`         |
| Scuola Superiore Meridionale di Napoli                                        | SSM           | Hosting    | [ssm.esse3.cineca.it](https://ssm.esse3.cineca.it)                     | `https://sissa.esse3.cineca.it/e3rest/docs/`         |
...
| Università per stranieri "Dante Alighieri" di Reggio Calabria                 | UNIST         | Hosting    | [unist.esse3.cineca.it](https://unist.esse3.cineca.it)                 | `https://unist.esse3.cineca.it/e3rest/docs/`         |
| Università per stranieri "Dante Alighieri" di Siena                           | UNISTRASI     | Hosting    | [unistrasi.esse3.cineca.it](https://unistrasi.esse3.cineca.it)         | `https://unistrasi.esse3.cineca.it/e3rest/docs/`     |
...
| Università Ca' Foscari Venezia                                                | UNIVE         | Hosting    | [unive.esse3.cineca.it](https://unive.esse3.cineca.it)                 | `https://unive.esse3.cineca.it/e3rest/docs/`         |
...
| Università della Valle d'Aosta                                                | UNIVDA        | Hosting    | [univda.esse3.cineca.it](https://univda.esse3.cineca.it)               | `https://univda.esse3.cineca.it/e3rest/docs/`        |
...
| Università di Scienze Gastronomiche                                           | UNISG         | Hosting    | [unisg.esse3.cineca.it](https://unisg.esse3.cineca.it)                 | `https://unisg.esse3.cineca.it/e3rest/docs/`         |
...
| Università telematica Guglielmo Marconi di Roma                               | UNIMARCONI    | In-house   | [unimarconi.esse3.cineca.it](https://unimarconi.esse3.cineca.it)       | `https://unimarconi.esse3.cineca.it/e3rest/docs/`    |
| Università telematica internazionale UNINETTUNO di Roma                       | UNINETTUNO    | In-house   | [uninettuno.esse3.cineca.it](https://uninettuno.esse3.cineca.it)       | `https://uninettuno.esse3.cineca.it/e3rest/docs/`    |
...
| Libera Università, Vita-Salute San Raffaele di Milano                         | UNISR         | Hosting    | [unisr.esse3.cineca.it](https://unisr.esse3.cineca.it)                 | `https://unisr.esse3.cineca.it/e3rest/docs/`         |
...
| Università degli Studi di Salerno                                             | UNISA         | Hosting    | [unisa.esse3.cineca.it](https://unisa.esse3.cineca.it)                 | `https://unisa.esse3.cineca.it/e3rest/docs/`         |
...
| Università degli Studi di Teramo                                              | UNITE         | Hosting    | [unite.esse3.cineca.it](https://unite.esse3.cineca.it)                 | `https://unite.esse3.cineca.it/e3rest/docs/`         |
...
| Libera Università Mediterranea "Giuseppe Degennaro"                           | LUM           | Hosting    | [lum.esse3.cineca.it](https://lum.esse3.cineca.it)                     | `https://lum.esse3.cineca.it/e3rest/docs`            |
...
| Università degli Studi di Napoli "L'Orientale"                                | UNIOR         | Hosting    | [unior.esse3.cineca.it](https://unior.esse3.cineca.it)                 | `https://unior.esse3.cineca.it/e3rest/docs/`         |
| Link Campus University                                                        | UNILINK       | Hosting    | [unilink.esse3.cineca.it](https://unilink.esse3.cineca.it)             | `https://unilink.esse3.cineca.it/e3rest/docs/`       |
